...
class MoodEnergyChart extends StatelessWidget {
  const MoodEnergyChart({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final moodEnergyData = isMonthly
          ? controller.getMonthlyMoodEnergyData()
          : controller.getMoodEnergyData();
            ...
            children: [
              ...
              SizedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    width: isMonthly ? (days.length * 24.w) : 1.sw,
                    child: BarChart(
                      BarChartData(
                        alignment: isMonthly
                            ? BarChartAlignment.start
                            : BarChartAlignment.spaceAround,
                        groupsSpace: isMonthly ? 6 : 12,
                        maxY: 11,
                              ...
                              getTitlesWidget: (value, meta) {
                                return SideTitleWidget(
                                  ...
                                  child: Transform.rotate(
                                    angle: isMonthly ? -0.5 : 0,
                                    child: Text(
                                      days[value.toInt()],
                                      style: TextStyle(
                                        color: const Color(0xFF9E9E9E),
                                        fontSize: isMonthly ? 8.sp : 10.sp,
                                      ),
                                    ),
                                  ),
                                );
                              },
                              reservedSize: isMonthly ? 40 : 28,
                            ),
                          ),
                        ...
                        barGroups: moodEnergyData.asMap().entries.map((entry) {
                          final int x = entry.key;
                          final List<double> data = entry.value;
