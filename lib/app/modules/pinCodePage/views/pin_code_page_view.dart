...
class PinCodePageView extends StatefulWidget {
  const PinCodePageView({super.key});

  @override
  _PinCodePageViewState createState() => _PinCodePageViewState();
}

class _PinCodePageViewState extends State<PinCodePageView> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                Get.toNamed(Routes.CONFIRM_PIN_CODE_PAGE);
              },
              child: Container(
                width: 343.w,
